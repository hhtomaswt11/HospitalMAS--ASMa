...
COORDINATOR_RECEIVE_TIMEOUT_SECONDS = 5
COORDINATOR_PROPOSAL_TIMEOUT_SECONDS = 3
RESOURCE_RECEIVE_TIMEOUT_SECONDS = 10

CONTRACT_NET_RESPONSE_WAIT_SECONDS = 2
...
CONSULTATION_DURATION_NORMAL_SECONDS = 15
CONSULTATION_DURATION_URGENT_SECONDS = 4
EXAM_RESULTS_WAIT_SECONDS = 6
SURGERY_DURATION_SECONDS = 8
