    ...
    class ClassifyUrgentPatientBehaviour(OneShotBehaviour):
        ...
        async def run(self):
            ...
            log(
                ...
                f"[TRIAGEM] {nome} classificado com prioridade={self.data['prioridade']} e especialidade={self.data['especialidade']}.",
                "YELLOW",
            )
        ...
        async def run(self):
            ...
            if performative == "cfp":
                ...
                if self.agent.disponivel:
                    ...
                    log(self.agent.nome_medico, f"[TRIAGEM] Proposta enviada para {data.get('nome', '?')}.", "YELLOW")
                else:
